...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String publicKey = RSAUtils.toBase64(keyPair.getPublic());
        String privateKey = RSAUtils.toBase64(keyPair.getPrivate());
        System.out.println(privateKey);
        System.out.println(publicKey);
        System.out.println("********************************************");
        String password = "shuaizihhhh";
        String passwordWithRSA = RSAUtils.encryptToString(password, RSAUtils.getPublicRSAKey(publicKey));
        String password2 = RSAUtils.decryptToString(passwordWithRSA, RSAUtils.getPrivateRSAKey(privateKey));
